...
<html>
    ...
    <body>
        <section class="header">
            <nav>
                <a href="Index.html"><img src="logo1.png" width="200" height="200"></a>
            ...
            <div class="text-box">
                <h1>World's Best Airline AirStar</h1>
                <p>Having the world best AirStar airline is one of the most faster growing company in the world.
                <br>It also provide's the best and a fast booking service you will ever experience.
                </p>
                <a href="" class="hero-btn" onclick="hideMenu()">Visit Us To Know More</a>
            </div>
        </section>
...
<section class="welcome">
    ...
    <div class="row">
        <div class="welcome-col">
            <h3>Best Team</h3>
            <img src="crew.jpg" width="250" height="200">
        ...
        <div class="welcome-col">
            ...
            <img src="food.jpg" width="250" height="200">
        ...
        <div class="welcome-col">
            <h3>Easy Booking</h3>
            <img src="ticket.jpg" width="250" height="200">
...
<section class="destination">
    ...
    <p>We will take you around the globle 24/7/365 to any destination of your choice at any time.</p>
...
<section class="seats">
    <h1>A fantastic travel class</h1>
    <p>We also provide you with the most comfortable seats class.</p>
...
<section class="review">
    <h1>What Our Passenger Says</h1>
    <p>See here on what our Passengers has said about our AirStar Airline Services.</p>

    <div class="row">
        <div class="review-col">
            <img src="jackie.jpg">
            <div>
                <p>"I have really enjoyed travelling around the world with AirStar Airline and will continue to do so."</p>
                <h3>Jackie Chan</h3>
            </div>
        </div>
        <div class="review-col">
            <img src="rock.jpg">
            <div>
                <p>"This is far the best of the best airline ever."</p>
...
<section class="ctu">
    <h1>Please Book your Air plane ticket with Us!</h1>
